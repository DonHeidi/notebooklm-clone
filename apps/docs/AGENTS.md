...
- Content is **rendered, never copied**: content collections in
  ...
  `product/`, `product/history/`, `product/architecture/`, and `handovers/`
  directories, which stay the single source of truth. Never duplicate or edit those files from here; presentation fixes
